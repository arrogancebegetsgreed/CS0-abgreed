"""
Lab - String
By: Caine Mayhew #fixed

CSCI 110
Date: 3/14/2024 #fixed
...
def main():
    ...
    while True:
        ...
        if hasDigit(phrase):
            ...
            print('{} does not contain a digit.'.format(phrase))

        # FIXME4
        # print if the phrase has a digit by calling the proper function
        
        if hasSymbol(phrase):
            print('{} contains a symbol.'.format(phrase))
        else:
            print('{} does not contain a symbol.'.format(phrase)) 
